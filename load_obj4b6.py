...
def fill_object(tr,polygon_verts,faces,vertices):
...
def window(args):
    ...
    try:
        ...
        if not load_error:
            ...
            if args.fill_object > 0.0:
                fill_object(args.fill_object,polygon_verts,faces,vertices)
...
def main():
    ...
    parser.add_argument('-fill','--fill_object',default=0.0,type=check_range,help="Set model opacity")
